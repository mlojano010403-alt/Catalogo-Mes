...
def cargar_datos_reales():
    ...
    muebles_lista = [
        ...
        (3, 'Mesa Patas Coloniales', 'Comedor_Mesa_Cuadrada_Patas_Coloniales.png', 'Mesa tradicional con patas robustas de diseño colonial.'),
        ...
        (3, 'Mesa Pedestal Grueso', 'Comedor_Mesa_Redonda_Pedestal_Grueso.png', 'Mesa con base central de madera maciza torneada.'),
        (3, 'Sillas Medallón', 'Comedor_Mesa_Redonda_Sillas_Medallon.png', 'Juego de comedor clásico con sillas de respaldo tipo medallón.'),
        (3, 'Mesa Té Madera', 'Comedor_Mesa_Redonda_Te_Madera.png', 'Mesa circular ideal para áreas de café o té.'),
        (3, 'Vitrina Esquinera Curva', 'Comedor_Vitrina_Esquinera_Curva.png', 'Vitrina diseñada para esquinas con frentes de vidrio.'),
        ...
        (8, 'Puertas Blancas Lisas', 'Deco_Puertas_Interiores_Blancas_Lisas.png', 'Set de puertas minimalistas para estancias interiores.'),
        ...
        (8, 'Marco Arcángel', 'Deco_Religioso_Cuadro_Arcangel_Marco.png', 'Marco de arte sacro tallado con detalles coloniales.'),
        (8, 'Peana Escultura', 'Deco_Religioso_Escultura_Peana.png', 'Base sólida para exhibición de estatuaria religiosa.'),
